...
const Icons = {
  ...
  folderOpen: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/><polyline points="2 8 22 8"/></svg>`,
  ...
  sort: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m3 16 4 4 4-4"/><path d="M7 20V4"/><path d="m21 8-4-4-4 4"/><path d="M17 4v16"/></svg>`,
  ...
  checkSquare: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 11 12 14 22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>`,
...
window.Icons = {
  ...
  // 批量替换页面中的 emoji 图标
  replaceEmojis(container = document.body) {
    const replacements = {
      '🔖': 'bookmark',
      '📁': 'folder',
      '📂': 'folderOpen',
    ...
    while (node = walker.nextNode()) {
      ...
      for (const emoji in replacements) {
        if (text.includes(emoji)) {
          nodesToReplace.push({ node, emoji, iconName: replacements[emoji] });
        }
      }
    }
    ...
    nodesToReplace.forEach(({ node, emoji, iconName }) => {
      ...
      parts.forEach((part, index) => {
        ...
        if (index < parts.length - 1) {
          ...
          iconSpan.innerHTML = this.get(iconName);
